...
const Register = () => {
    const { registerUser, updateUserName } = useContext(authContext);
    ...
    return (
        <div>
            <div className="flex flex-col items-center min-h-screen mt-20 sm:justify-center sm:pt-0 bg-gray-50">
